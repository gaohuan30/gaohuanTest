package com.gaohuan.excel.controller;

/**
 * Created by gaohuan on 2017/8/2.
 */
...
public class FileController {
    ...
    public String upload(@RequestParam("test") MultipartFile file) {
        ...
        try {
            ...
            return "上传成功<a href='/index.html'>返回</a>";
            ...
            if (!file.isDirectory()) {
                ...
                for (int i = 0; i < filelist.length; i++) {
                    ...
                    if (!readfile.isDirectory()) {
                        ...
                        excelList.add(readfile.getName());
     ...
     * 将文件上传
     */
    public void addExcel(@RequestParam("test") MultipartFile file){
